...
enum ImGuiTreeNodeFlags_
{
    ...
    ImGuiTreeNodeFlags_OpenOnArrowClick = 1 << 15,  // (WIP) Nav: left direction may move to this TreeNode() from any of its child (items submitted between TreeNode and TreePop)
